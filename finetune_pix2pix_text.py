...
from transformers import CLIPTextModel, CLIPTokenizer, ChineseCLIPProcessor, ChineseCLIPTextModel, AutoTokenizer
...
def parse_args():
    ...
    parser.add_argument(
        ...
        required=False,
        help="Path to pretrained model, in this task is the chinese CLIP path",
    )
    parser.add_argument(
        "--revision",
        type=str,
...
def main():
    ...
    # tokenizer = chinese_clip_processor.tokenizer
    text_encoder = CLIPTextModel.from_pretrained(
        args.pretrained_model_name_or_path,
        subfolder="text_encoder",
        revision=args.revision,
    )
    # tokenizer = AutoTokenizer.from_pretrained("OFA-Sys/chinese-clip-vit-base-patch16",max_length=35)
    # text_encoder = ChineseCLIPTextModel.from_pretrained(
    #     args.pretrained_clip_model_name_or_path,
    #     revision=args.revision,
    # )
    #####
